  ...
  navbarPage("SMART Sample Size Calculator for Pilot studies", id="SMARTsize",
                                   ...
                                   tags$ul(
                                     ...
                                     tags$li("Adaptive Interventions (AI) are named by concatenating the first-stage treatment, the second-stage treatment for responders and that of non-responders.
                                             For example, the AI 'Give A; then, if response, give C; if no response, give E' is named 'ArCnrE'."
								                   ...
								                   p("Please direct correspondence to", a(href = "d3center-code@umich.edu", "d3center-code@umich.edu.")),
								                   p("App code is by Nick Seewald and Hwanwoo Kim.")
                      ),
             ...
             tabPanel("Design A",
                      sidebarPanel(h4("About this design:"),
                                   ...
                                   #   behavioral intervention for woman who are pregnant and abusing drugs. For more information about SMARTs, see 'Advancing the science of adaptive interventions'", 
                                   #   a(href = "https://d3c.isr.umich.edu/advancing-the-science-of-adaptive-interventions/#smart", "https://d3c.isr.umich.edu/advancing-the-science-of-adaptive-interventions/#smart")),
                                   tags$hr(),
                                   h4("Inputs:"),
                                   tags$ul(
                      ...
                      mainPanel(
                        ...
                        numericInput("prespA", 
                                              label = " ",
                                              value=0.3, min = 0.000001, max = 0.999999, step = 0.000001),
                       ...
                       fluidRow(
                       p("What is the", strong("minimum number of participants would you like to observe in each subgroup?"), numericInput("SizeThresholdA", label = " ", value = 4, min = 1, max = 30, step = 1)),
             ...
             tabPanel("Design B",
                      ...
                      sidebarPanel(h4("About this design:"),
                                   ...
                                   # p("An example of SMART study with design B is a SMART study for adolescent mariguana usage. For more information about SMARTs, see 'Advancing the science of adaptive interventions'", 
                                   #   a(href = "https://d3c.isr.umich.edu/advancing-the-science-of-adaptive-interventions/#smart", "https://d3c.isr.umich.edu/advancing-the-science-of-adaptive-interventions/#smart")),
                                   tags$hr(),
                                   h4("Inputs:"),
                                   tags$ul(
                      ...
                      mainPanel(
                        ...
                        tags$hr(),
                        fluidRow(
                          p("What is the", strong("minimum number of participants would you like to observe in each subgroup?"), numericInput("SizeThresholdB", label = " ", value = 4, min = 1, max = 30, step = 1)),
                          tags$hr(),
             ...
             tabPanel("Design C",
                      sidebarPanel(h4("About this design:"),
                                   ...
                                   # p("An example of SMART study with design C is a SMART study for improving outcomes of a mental disorders program. For more information about SMARTs, see 'Advancing the science of adaptive interventions'", 
                                   #   a(href = "https://d3c.isr.umich.edu/advancing-the-science-of-adaptive-interventions/#smart", "https://d3c.isr.umich.edu/advancing-the-science-of-adaptive-interventions/#smart")),
                                   tags$hr(),
                                   h4("Inputs:"),
                                   tags$ul(
                      ...
                      mainPanel(
                        ...
                        tags$hr(),
                        fluidRow(
                          p("What is the", strong("minimum number of participants would you like to observe in each subgroup?"), numericInput("SizeThresholdC", label = " ", value = 4, min = 1, max = 30, step = 1)),
                          tags$hr(),
			...
			########### DESIGN D ###########
             ...
             tabPanel("Design D",
                      sidebarPanel(h4("About this design:"),
                                   p("Design D is a SMART in which all participants are re-randomized, and the second-stage treatment options are not influenced by the response/non-response status.",
                                     "The interventions embedded in this SMART are thus non-adaptive, since information observed prior to the
                                   ...
                                   # p("An example of a SMART study with design D is a SMART study for adolescent mariguana usage. For more information about SMARTs, see 'Advancing the science of adaptive interventions'", 
                                   #   a(href = "https://d3c.isr.umich.edu/advancing-the-science-of-adaptive-interventions/#smart", "https://d3c.isr.umich.edu/advancing-the-science-of-adaptive-interventions/#smart")),
                                   tags$hr(),
                                   h4("Inputs:"),
                                   tags$ul(                   
